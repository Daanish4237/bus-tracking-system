...
function seed() {
  ...
  const stopData: Stop[] = [
    // ── Sample routes (kept for reference) ──────────────────────────────────
  ...
  const routeData: Route[] = [
    ...
    {
      id: 'route-541',
      name: 'Bus 541 — Kinrara BK5 → Putra Permai',
      stopIds: [
        's541-01','s541-02','s541-03','s541-04','s541-05','s541-06','s541-07',
        's541-08','s541-09','s541-10','s541-11','s541-12','s541-13','s541-14',
        's541-15','s541-16','s541-17','s541-18','s541-19','s541-20','s541-21',
        's541-22','s541-23','s541-24','s541-25',
      ],
  ...
  const busData: BusLocation[] = [
    ...
    // Bus 541 — currently at Melody Kinrara (Barat), heading south-east
